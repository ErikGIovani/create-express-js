...
const FRAMEWORKS: Framework[] = [
  ...
  // {
  //   name: "express-apollo",
  //   display: "Express Apollo Server",
  //   color: yellow,
  // },
  // {
  //   name: "express-apollo-ts",
  //   display: "Express Apollo Server TypeScript",
  //   color: blue,
  // },
  // {
  //   name: "express-socket.io",
  //   display: "Express Socket.IO",
  //   color: yellow,
  // },
  // {
  //   name: "express-socket.io-ts",
  //   display: "Express Socket.IO TypeScript",
  //   color: blue,
  // },
  // {
  //   name: "express-trpc",
  //   display: "Express tRPC",
  //   color: blue,
  // },
];
